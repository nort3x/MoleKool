package com.iskportal.molekule.visual
...
import com.iskportal.molekule.visual.plugins.EnvironmentMainPlugin
import com.iskportal.molekule.visual.plugins.KoolVizualizerPlugin
...
class KoolVisualizer(cfg: KoolConfig = defaultKoolConfig()) {
    ...
    fun addEnvironment(environment: com.iskportal.molekule.core.Environment): KoolVisualizer {
